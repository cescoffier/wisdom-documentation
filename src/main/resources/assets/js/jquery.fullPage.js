		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				$(this).find('.fp-slides').after('<div class="fp-controlArrow fp-prev fa fa-chevron-left fa-2x"></div><div class="fp-controlArrow fp-next fa fa-chevron-right fa-2x"></div>');
